...
export const layoutKeys = ['landing-a', 'landing-b', 'landing-c', 'landing-v1', 'landing-v2', 'landing-v3', 'landing-v4', 'landing-v5'];
export const variantToLayout = { v1: 'landing-v1', v2: 'landing-v2', v3: 'landing-v3', v4: 'landing-v4', v5: 'landing-v5' };
...
export const variantProfiles = {
  default: {
    ...
    socialDesc: 'Testimonios y senales de confianza para reforzar la decision antes de la consulta.',
    ctaHeadlinePrefix: 'Solicita una landing para captar',
    ctaDesc: 'Recibe una propuesta clara, estructura de conversion y una ruta directa hacia la consulta.',
  },
  v1: {
    ...
    socialDesc: 'Bloques pensados para reducir dudas rapido y aumentar la intencion antes de pedir propuesta.',
    ctaHeadlinePrefix: 'Quiero una landing para conseguir',
    ctaDesc: 'Priorizamos mensaje, CTA y accion directa para convertir trafico en oportunidades accionables.',
  },
  v2: {
    ...
    processTone: 'Presentacion mas limpia y jerarquica para reforzar autoridad, claridad y una accion simple.',
  ...
  v3: {
    ...
    proof: [
      ...
      { value: 'Lead ready', label: 'consulta guiada' },
    ...
    ctaDesc: 'Pensada para marcas que quieren mas presencia, mejor percepcion y una consulta comercial mas calificada.',
  },
  v4: {
    heroTag: 'Sales control',
    proof: [
      { value: 'Lead ready', label: 'mensaje comercial' },
      { value: 'CTA claro', label: 'decision sin friccion' },
      { value: 'Alta intencion', label: 'respuesta priorizada' },
    ],
    processTone: 'Composicion enfocada en ventas: menos rodeos, mas claridad comercial y pasos orientados al cierre.',
    servicesTitle: 'Oferta, prueba y accion comercial',
    socialTitle: 'Prueba de venta visible',
    socialDesc: 'La prueba social funciona como acelerador de decision dentro de una narrativa mas comercial.',
    ctaHeadlinePrefix: 'Necesito una landing comercial para captar',
    ctaDesc: 'Disenada para vender una propuesta con mas precision, mas autoridad y una ruta directa a la consulta.',
  },
  v5: {
    heroTag: 'Premium minimal',
    proof: [
      { value: 'Menos ruido', label: 'jerarquia limpia' },
      { value: 'Mas foco', label: 'decision guiada' },
      { value: 'Premium', label: 'presencia de marca' },
    ],
    processTone: 'Una narrativa mas curada y silenciosa, pensada para marcas que venden confianza desde la composicion.',
    servicesTitle: 'Oferta curada y posicionamiento',
    socialTitle: 'Confianza con menos ruido visual',
    socialDesc: 'La prueba social acompaña una estructura mas aireada, elegante y editorial.',
    ctaHeadlinePrefix: 'Busco una landing sobria para captar',
    ctaDesc: 'Orientada a negocios que necesitan una presentacion premium, limpia y claramente comercial.',
  },
};
...
export const sectionCopyByProfile = {
  ...
  health: {
    ...
    steps: [
      ...
      { title: 'Estructura para turnos y consultas', desc: 'Ordenamos prueba social, servicios y CTA para reducir dudas antes de la reserva.' },
  ...
  legal: {
    ...
    steps: [
      ...
      { title: 'Canal comercial listo para cerrar', desc: 'La landing sale publicada con consulta visible y ruta directa hacia la reunion inicial.' },
    ],
...
export function normalizeVariantKey(value) {
  ...
  if (normalized === 'landing-a' || normalized === 'landing-v1') return 'v1';
  if (normalized === 'landing-b' || normalized === 'landing-v2') return 'v2';
  if (normalized === 'landing-c' || normalized === 'landing-v3') return 'v3';
  if (normalized === 'landing-v4') return 'v4';
  if (normalized === 'landing-v5') return 'v5';
  if (normalized === 'v1' || normalized === 'v2' || normalized === 'v3' || normalized === 'v4' || normalized === 'v5') return normalized;
  return 'default';
}

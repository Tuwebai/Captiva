...
export function composeSections(context) {
  ...
  const replacements = {
    ...
    TESTIMONIAL_2_TEXT: `Ahora el visitante entiende rapido el servicio y llega a la consulta con mas intencion.`,
    TESTIMONIAL_3_TEXT: `La nueva estructura ordeno el mensaje y mejoro la calidad del primer intercambio.`,

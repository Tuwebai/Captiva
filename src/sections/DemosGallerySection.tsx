              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  <PrimaryCTA
                    ...
                    mode="whatsapp"
                    source="demos-hero"
                    context={normalizedIndustryFilterKey === 'all' ? 'captiva-demos-hero' : `captiva-demos-hero-${normalizedIndustryFilterKey}`}
                    industry={normalizedIndustryFilterKey === 'all' ? undefined : normalizedIndustryFilterKey}
                    className="ui-btn-primary inline-flex items-center justify-center gap-2.5 rounded-2xl px-7 py-4 text-base font-bold text-white glow-brand-sm"
                    icon={

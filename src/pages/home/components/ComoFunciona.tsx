  ...
  return (
    <section id="como-funciona" className="py-20 md:py-28 relative">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="ui-divider-line absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-px" />
          ...
          {steps.map((step, i) => (
            <div key={step.num} className="relative">
              ...
              <div className="ui-card rounded-3xl p-5 sm:p-7 h-full hover:border-zinc-700 transition-all duration-300 hover:shadow-xl group">
                ...
                {/* Time badge */}
                <div className="ui-card-soft mt-6 inline-flex items-center gap-2 rounded-xl px-3 py-2">
                  <div>

export const copyConfig = {
  hero: {
    ...
    eyebrow: 'Hecho para negocios en Argentina y Latinoamérica',
    title: 'Tu página lista en 5 días. Tus clientes empiezan a llegar el lunes.',
    subtitle: '',
    supportingCopy:
    ...
    panelFlowNodes: ['Visitas', 'Landing', 'Consultas'] as [string, string, string],
  ...
  benefits: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'La marca deja de depender solo de redes y suma un activo digital preparado para crecer, con hosting + dominio incluidos por 1 año.',
      },
    ],
  },
  socialProof: {

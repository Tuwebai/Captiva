  ...
  return (
    <section id="cta-final" className="py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-5 md:px-8 text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-violet-600/15 border border-violet-500/25 text-violet-300 text-xs font-semibold px-4 py-2 rounded-full mb-8">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-3 bg-violet-600 hover:bg-violet-500 text-white font-black text-lg px-10 py-5 rounded-2xl transition-all duration-200 hover:shadow-2xl hover:shadow-violet-500/30 hover:-translate-y-1 mb-5 glow-brand"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-xl mx-auto">
          {[
            ...
            <div
              key={item.label}
              className="flex flex-col items-center gap-2 bg-[#111113]/80 border border-[#27272A] rounded-2xl p-4"
            >

...
export default function CTAFinal() {
  return (
    <section id="contacto" className="py-24 px-5 md:px-8">
      <div className="max-w-5xl mx-auto rounded-[2rem] border border-violet-500/20 bg-gradient-to-br from-violet-600/15 via-white/[0.03] to-emerald-500/10 p-10 md:p-14 text-center shadow-2xl">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3 text-sm text-zinc-300">
          <span className="rounded-full border border-white/10 bg-white/[0.03] px-4 py-2">Dominio incluido</span>
          <span className="rounded-full border border-white/10 bg-white/[0.03] px-4 py-2">WhatsApp integrado</span>
          <span className="rounded-full border border-white/10 bg-white/[0.03] px-4 py-2">Lanzamiento rápido</span>
        </div>

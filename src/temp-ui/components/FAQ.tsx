...
function FAQItem({ item, index }: { item: typeof faqs[0]; index: number }) {
  ...
  return (
    <div className={`border rounded-2xl overflow-hidden transition-all duration-300 ${open ? 'border-violet-500/30 bg-[#111113]' : 'border-[#27272A] bg-[#0D0D0F] hover:border-[#3F3F46]'}`}>
      <button
      ...
      >
        ...
        <div className={`shrink-0 w-6 h-6 rounded-lg flex items-center justify-center transition-all duration-300 ${open ? 'bg-violet-600 rotate-45' : 'bg-[#1A1A1F] border border-[#27272A]'}`}>
    ...
    <section id="faq" className="py-20 md:py-28 relative">
      ...
      <div className="relative max-w-3xl mx-auto px-5 md:px-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-zinc-800/60 border border-[#27272A] text-zinc-400 text-xs font-semibold px-4 py-2 rounded-full mb-5">
            Sin letra chica
          </div>
